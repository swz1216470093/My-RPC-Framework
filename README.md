...
5. 序列化协议 本实现支持JDK和JSON序列化协议	

6. 负载均衡 本实现支持随机和轮询两种策略。

7. 注册中心 本实现选用Nacos作为注册中心。

## 实现

### 项目总体结构

<img src="https://raw.githubusercontent.com/swz1216470093/blogComments/master/img/20210728175723.png" style="zoom:50%;" />

### netty传输模块

<img src="https://raw.githubusercontent.com/swz1216470093/blogComments/master/img/20210728180220.png" style="zoom:50%;" />

启动前扫描所有标记了RpcService注解的类 注册到注册中心 
...
ServerHandler当接收到客户端请求，从注册中心的缓存中找到服务对象，反射调用请求的方法 用响应消息包装返回值
...
public class ClientTest {
    public static void main(String[] args) {
        ...
        final HelloService helloService2 = (HelloService) new JdkServiceProxy(new Netty()).getProxy(HelloService.class);
        System.out.println(helloService2.say("netty"));
